...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Sphere point2 = {{0.8f, 0.0f, 1.0f} , 0.4f};
	...
	while (Novice::ProcessMessage() == 0) {
		...
		ImGui::DragFloat3("Point2Center" , &point2.center.x , 0.01f);
		ImGui::DragFloat("Point2Radius" , &point2.radius , 0.01f);

		if (IsCollision(point1 , point2)) {
			color = RED;
		} else
			color = WHITE;
		...
		DrawSphere(point2 , projectionMatrix , viewportMatrix , WHITE);
